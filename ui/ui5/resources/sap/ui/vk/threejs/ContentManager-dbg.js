...
sap.ui.define([
	...
	ContentManager.prototype._findLoader = function(contentResource) {
		// load vds4 with MataiLoader as default resolver, patch for 1.71
		if (contentResource.getSourceType() === "vds4") {
			return new Promise(function(resolve) {
				sap.ui.require([ "sap/ui/vk/threejs/MataiLoader" ], function(MataiLoader) {
					resolve(MataiLoader);
				});
			});
		}
