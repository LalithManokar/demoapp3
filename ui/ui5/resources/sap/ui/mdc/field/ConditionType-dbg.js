...
sap.ui.define([
					...
					if (!_isCompositeType.call(this, oType)) {
						if (oOperator.name === "EEQ" && oFieldHelp) {
							if (oCondition.values[0] !== null && oCondition.values[0] !== undefined) {
								...
								oCondition = _parseDetermineKey.call(this, oCondition, oType, oFieldHelp, true, bCheckForDefault, oFilterOperatorConfig, vValue, sDisplay);
								if (oCondition instanceof Promise) {
									return _fnReturnPromise.call(this, oCondition);
								}
							} else if (vValue === "") {
	...
	function _parseDetermineKey(oCondition, oType, oFieldHelp, bCheckDescription, bCheckForDefault, oFilterOperatorConfig, vValue, sDisplay) {
		...
		if (oCondition.values[1] === "") {
			...
			return _parseNoKeyFound.call(this, oCondition, oType, oFieldHelp, bCheckDescription, bCheckForDefault, oFilterOperatorConfig, vValue, sDisplay, undefined);
		}
