...
sap.ui.define([],
	 ...
	 * The controls or entities have to implement the following APIs: <code>search</code> & <code>getFilters</code> methods along with the <code>search</code> & <code>filtersChanged</code> events
	 *
	 * @since 1.70
