...
sap.ui.define([
								...
								if (aDateTypes.indexOf(oFilterFieldMetadata.filterType) > -1) {
									...
									if (oType) {
										if (value1 !== "" && (value1 !== undefined)) {
											if ((oFilterFieldMetadata.filterType === "numeric") && typeof value1 === "string" && !isNaN(value1)) {
										...
										if (value2 !== "" && (value2 !== undefined)) {
											if ((oFilterFieldMetadata.filterType === "numeric") && typeof value2 === "string" && !isNaN(value2)) {
					...
					if (oRangeData && (oToken.getKey().indexOf("range_") === 0)) {
						if (oFieldViewMetadata.type === "Edm.Time") {
							if (oRangeData.value1 && (oRangeData.value1.ms || oRangeData.value1.ms === 0)) {
								oRangeData.value1 = DateTimeUtil.utcToLocal(new Date(oRangeData.value1.ms));
							}
							if (oRangeData.value2 && (oRangeData.value2.ms || oRangeData.value2.ms === 0)) {
								oRangeData.value2 = DateTimeUtil.utcToLocal(new Date(oRangeData.value2.ms));
							}
						}
					}
							...
							while (iLen--) {
								...
								if (aValue[iLen].exclude) { // Exclude Select Option is not supported entirely except EQ and Empty, which can be
									...
									if (aValue[iLen].operation === ValueHelpRangeOperation.Empty) {
										aExcludeFilters.push(FilterProvider._getStringEmptyFilter(sField, oFieldMetadata,true));
									} else if (aValue[iLen].operation === FilterOperator.EQ) {
										aExcludeFilters.push(new Filter(sField, FilterOperator.NE, oValue1));
									}
								} else {
									if (aValue[iLen].operation === ValueHelpRangeOperation.Empty) {
										aArrayFilters.push(FilterProvider._getStringEmptyFilter(sField, oFieldMetadata));
	 ...
	 * @param {boolean=false} bExclude - Is this exclude or include operation
