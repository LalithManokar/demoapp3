...
sap.zen.crosstab.utils.Utils.prepareStringForRendering = function (sText) {
	...
	var sPreparedString = sText.replace(/&#x20;/g, "&nbsp;");
	// encode the text so the renderer can handle special characters
	var encodeXML = sap.ui.require("sap/base/security/encodeXML");
	sPreparedString = encodeXML(sPreparedString);
	// replace the encoded line breaks with <br/> so they are respected by the HTML renderer
	sPreparedString = sPreparedString.replace(/(&#xd;&#xa;)|(&#xa;&#xd;)|&#xd;|&#xa;/g, "<br/>");
