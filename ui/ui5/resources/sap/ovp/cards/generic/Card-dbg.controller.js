sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
        ...
        "sap/ovp/app/OVPUtils", "sap/base/Log", "sap/ui/events/KeyCodes", "sap/base/util/merge", "sap/base/util/isPlainObject", "sap/ui/util/openWindow"],
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, GenericAppLibrary, jQuery, OvpResources, OVPUtils, Log, KeyCodes, merge, isPlainObject, openWindow) {
        "use strict";
        return Controller.extend("sap.ovp.cards.generic.Card", {
            ...
            setHeaderCounter: function (oItemsBinding, countFooter, oEvent) {
                var iTotal;
