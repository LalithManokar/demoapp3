sap.ui.define(["sap/ovp/cards/generic/Card.controller", "sap/ui/thirdparty/jquery",
    ...
    "sap/ovp/cards/AnnotationHelper", "sap/ui/model/Sorter", "sap/ovp/app/resources", "sap/base/Log", "sap/base/util/each"],
    function (CardController, jQuery, VizAnnotationManager, MetadataAnalyser, SmartAnnotationManager, Filter,
              AnnotationHelper, Sorter, OvpResources, Log, each) {
        "use strict";
...
//            mBindingParams.parameters.custom = { "top" : 3};
                ...
                if (bSorter) {
                    ...
                    each(oPresentationVariant.SortOrder, function () {
