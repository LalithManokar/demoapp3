sap.ui.define([
        ...
        "sap/base/util/merge"
                 ...
                 JSONModel, OvpResources, OVPUtils, Log, merge) {
        "use strict";
            ...
            getDialogBox: function (oComponentContainer) {
                return new Promise(function (resolve, reject) {
                    ...
                    if (layer === OVPUtils.Layers.vendor) {
                        ...
                        var i18nModel = sap.ui.getCore().byId("mainView").getModel("i18n");
                        var aCustomBundles = i18nModel && i18nModel.oData.bundle.aCustomBundles;
                        if (aCustomBundles && Array.isArray(aCustomBundles) && aCustomBundles[0] && aCustomBundles[0].aPropertyFiles[0] && aCustomBundles[0].aPropertyFiles[0].mProperties) {
