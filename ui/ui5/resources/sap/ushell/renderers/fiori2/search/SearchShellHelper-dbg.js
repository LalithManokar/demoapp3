...
sap.ui.define([
    ...
    jQuery.extend(module, {
        ...
        registerFocusHandler: function () {
            ...
            that.oSearchSelect.addEventDelegate({
                onAfterRendering: function () {
                    ...
                    // domRef = domRef.querySelector('select'); // new: hidden select element within the dropdown is focused
                    domRef = domRef.querySelector('#searchFieldInShell-select-hiddenSelect');
        ...
        onAfterNavigate: function (oEvent) {
            ...
            // Shall the result item arrow be expanded?
            // Cover the case of navigating back from a fact sheet 
            // onAfterRendering is too early for this check 
            if (oSearchView) {
