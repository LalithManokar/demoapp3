...
/* global sap */ // eslint-disable-line no-redeclare
...
sap.ui.define([
    ...
    return sap.ui.core.Control.extend("sap.ushell.renderers.fiori2.search.controls.SearchFieldGroup", {
        ...
        initButton: function () {
                ...
                tooltip: {
                    ...
                    formatter: function (searchButtonStatus) {
                        if (searchButtonStatus === 'search') {
                            return sap.ushell.resources.i18n.getText("searchBtn");
                        } else {
                            return sap.ushell.resources.i18n.getText("closeSearchBtn");
                        }
                    }
                },
            ...
            var oInvisibleText = new sap.ui.core.InvisibleText(that.getId() + '-buttonAriaText', {
                text: {
                    parts: [{
                        path: '/searchButtonStatus'
                    }],
            ...
            that.setAggregation("_buttonAriaText", oInvisibleText);
        ...
        setModel: function (model) {
            ...
            this.getAggregation("_buttonAriaText").setModel(model);
        },
