...
sap.ui.define([
    ...
    SearchHelper, SearchLabel, SearchLink, SearchMap, SearchResultListItem, CustomSearchResultListItem, HBox
) {
    "use strict";
    ...
    return sap.ui.jsview("sap.ushell.renderers.fiori2.search.container.Search", {
        ...
        determineIfMaps: function (oContext) {
            ...
            return bIfMaps;*/
            return false; // deactivate map because of performance issues, vbm and vk library was loaded in single file mode 2
        },
        // display switch tap strips
        // ===================================================================
        ...
        assembleSearchResultMap: function () {
            ...
            return new HBox(); // deactivate map because of performance issues, vbm and vk library was loaded in single file mode
        },
