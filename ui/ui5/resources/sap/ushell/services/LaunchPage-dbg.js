...
sap.ui.define([
...
], function (ContentExtensionAdapterFactory, jQuery, resources, AppStatePersistencyMethod) {
    "use strict";
    ...
    function LaunchPage (oAdapter/*, oContainerInterface*/) {
        ...
        this.changeURLStatesToPersistent = function (sURL) {
            ...
            if (oAppState.getSupportedPersistencyMethods().length === 0 && bAppStateConfigPersistent !== true) {
                return;
            }
