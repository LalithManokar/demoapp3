            ...
            return oContainer.getService("NavTargetResolution")
                ...
                .then(function (oResult) {
                    return new jQuery.Deferred(function (oDeferred) {
                        ...
                        if (oResult.applicationType === "URL" &&
                            oResult.appCapabilities &&
                            oResult.appCapabilities.appFrameworkId === "UI5" &&
                            sap.ushell.Container.inAppRuntime && sap.ushell.Container.inAppRuntime()) {
