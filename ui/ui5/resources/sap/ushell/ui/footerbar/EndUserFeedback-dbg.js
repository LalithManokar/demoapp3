...
sap.ui.define([
    ...
    EndUserFeedback.prototype.ShowEndUserFeedbackDialog = function () {
        sap.ui.require([
            ...
            this.oLegalLayout = new VerticalLayout("legalLayout", { content: [this.oAnonymousCheckbox, this.oLegalAgrementCheckbox, this.oLegalAgreementLink] });
            ...
            this.oFeedbackLayout = new VerticalLayout("feedbackLayout", {
                ...
                content: [
                    ...
                    this.oRatingLayout,
                    this.oTextArea,
                    this.oTechnicalDataLayout,
                    this.oTechnicalInfoBoxLayout,
                    this.oLegalLayout,
                    this.oCustomUILayout
                ]
