...
sap.ui.define([
            ...
            renderer: {
                ...
                render: function (rm, shellAppTitle) {
                    ...
                    if (bVisible) {
                        ...
                        if (oModel && Config.last("/core/shellHeader/ShellAppTitleState") === oStateEnum.ALL_MY_APPS_ONLY) {
                    ...
                    rm.openStart("span");
                    rm.class("sapUshellAppTitleText");
                    rm.openEnd();
                    rm.text(sText || "");
                    rm.close("span");
    ...
    ShellAppTitle.prototype.onclick = function (oEvent) {
        ...
        if (Config.last("/core/shellHeader/ShellAppTitleState") === oStateEnum.ALL_MY_APPS_ONLY) {
    ...
    */
    ShellAppTitle.prototype._allMyAppsButtonPressHandler = function () {
        // might not be available, as AllMyApps might not be loaded yet
        if (sap.ui.getCore().byId(this.getAllMyApps())) {
            Measurement.start(
            ...
            this.getModel().setProperty("/ShellAppTitleState", oStateEnum.ALL_MY_APPS);
            this.oNavMenuPopover.close();
