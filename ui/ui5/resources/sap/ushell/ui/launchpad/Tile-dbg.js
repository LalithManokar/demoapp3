...
sap.ui.define([
    ...
    Tile.prototype.setVisible = function (bVisible) {
        // Rerendering must not be suppressed since SAPUI5 version 1.66 with the InvisibleRenderer in place.
        // The former technique to set/unset the CSS class "sapUshellHidden" and to suppress rendering became obsolete.
        // See BCP incident 80672.
