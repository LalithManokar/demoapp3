        ...
        */
        createContent: function (oController) {
            ...
            var bEnablePersonalization = this.oModel.getProperty("/personalization"),
                ...
                bEnableActionModeMenuButton = this.oModel.getProperty("/enableActionModeMenuButton") !== false,
            ...
            // Wait until core extension has been loaded, then prepare action mode if needed.
            this.oDoable = EventHub.once("CoreResourcesComplementLoaded").do(function () {

                // Enable menu,
                this.oAnchorNavigationBar.setOverflowEnabled(true);

                // Initialize action mode implementation,
                if ((bEnablePersonalization && bEnableActionModeMenuButton) || bEnableTileActionsIcon) {
                    sap.ui.require(["sap/ushell/components/homepage/ActionMode"], function (ActionMode) {
                        ActionMode.init(this.oModel);
                    }.bind(this));
                }

                // Create "Edit Home Page" entry in user menu
                // and footer used when home page is edited in tile action mode
                if (bEnablePersonalization && bEnableActionModeMenuButton) {
    ...
    var DashboardUIActions = baseObject.extend("sap.ushell.components.homepage.DashboardUIActions", {
        ...
        _handleTileToTileDrop: function (evt, tileElement, oAdditionalParams) {
            ...
            if (oAdditionalParams && oAdditionalParams.clone) {
                ...
                var splittedTransform = $Clone.css("transform").split(",");
                ...
                $Clone.css({
                    ...
                    transition: "transform 300ms cubic-bezier(0.46, 0, 0.44, 1)"
                });
                setTimeout(function () {
                    oDeferred.resolve();
                    handleTileDropInternal.call(this, evt, tileElement);
