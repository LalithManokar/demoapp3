    ...
    sap.ui.controller("sap.ushell.components.shell.UserSettings.DefaultParameters", {
        ...
        createAppropriateControl: function (grpel, oRecord) {
            ...
            grpel.addElement(new FlexBox({
                ...
                alignItems: Device.system.phone ? FlexAlignItems.Start : FlexAlignItems.Center,
                direction: (Device.system.phone && !expButton) ? FlexDirection.Column : FlexDirection.Row,
                items: [lbl, sf, expButton],
                wrap: FlexWrap.Wrap
            }));
        },
        ...
        onAfterRendering: function () {
            ...
            oDoable.do(function (sId) {
                ...
                items.forEach(function (oListItem) {
                    ...
                    oIcon.toggleStyleClass(
                        "sapUshellHCBIconStyleOnHCB",
                        that.currentThemeId.indexOf("_hcb") > -1 && (sThemeId || "").indexOf("_hcb") > -1
                    );
                    oIcon.toggleStyleClass(
                        "sapUshellHCWIconStyleOnHCW",
                        that.currentThemeId.indexOf("_hcb") < 0 && (sThemeId || "").indexOf("_hcw") > -1
                    );
                });
