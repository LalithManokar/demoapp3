    ...
    function fnCreateConfigContract (oMergedSapUshellConfig) {
        ...
        var oConfigDefinition = {
            core: { // the unified shell core
                ...
                pages: {
                    enable: getConfigValue("ushell/pages/enable", false),
                    assignedPages: getConfigValue("ushell/pages/assignedPages", {})
                },
                shellHeader: {
                    application: {},
                ...
                home: {
                    ...
                    editTitle: false,
                    // Feature switch: `core.shell.home.enableActionModeMenuButton`
                    // Function:       Tells if user menu offers the entry "Edit Home Page" to enter tile action mode.
                    // Dependency:     Has an effect only if main personalization switch `core.shell.enablePersonalization` has been activated.
                    // Used by:        SAP Enterprise Portal (EP-PIN-NAV-FFP)
                    ...
                    // enableTileDataPersonalization is only available in 1.71 and is only to be used by the
                    // Enterprise Portal to deactivate the 'Edit Tile Information' functionality.
                    enableTileDataPersonalization:
                        getConfigValue("renderers/fiori2/componentData/config/applications/Shell-home/enableTileDataPersonalization", true),
