sap.ui.define(["sap/ui/base/Object", "sap/suite/ui/generic/template/lib/testableHelper"], function(BaseObject,
	...
	function getMethods(oControllerBase, oController, oTemplateUtils) {
		...
		function fnHandleNavigateToObject(oPaginatorInfo, index){
			...
			var oMyNavigationData = Object.assign({}, oNavigationInfo.navigationData);
		...
		oTemplatePrivateModel.setProperty("/objectPage/navButtons", Object.assign({
	...
	return BaseObject.extend("sap.suite.ui.generic.template.detailTemplates.PaginatorButtonsHelper", {
		constructor: function(oControllerBase, oController, oTemplateUtils) {
			Object.assign(this, (testableHelper.testableStatic(getMethods, "PaginatorButtonsHelper"))(oControllerBase, oController,
				oTemplateUtils));
		}
	});
});
