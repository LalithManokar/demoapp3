	...
	function getMethods(oState, oController, oTemplateUtils) {
		...
		function fnStoreCurrentAppStateAndAdjustURL() {
			...
			if (sAppStateKeyInUrl === oStoringInformation.appStateKey){
				...
				// remember sAppStateKeyInUrl already here, as isStateChange can be called asynchronously (even later than fnAdaptToAppState)
				sAppStateKeyInUrl = oStoringInformation.appStateKey;
		...
		*/
		...
		function isStateChange(mAppStates){
			...
			if (oStoringInformation){
				if (!oTemplateUtils.oComponentUtils.isComponentActive()) {
