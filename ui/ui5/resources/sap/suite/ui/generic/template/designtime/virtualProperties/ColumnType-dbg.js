sap.ui.define([
	...
	ColumnType.createNewColumn = function (sRecordType, oOldRecord) {
		...
		var sProperty,
			...
			oRecordTemplate = {};
		oRecordTemplate[DATAFIELD] = Object.assign({}, oAbstractRecordTemplate,
			{
				Value: { Path: "" }
			});
		oRecordTemplate[DATAFIELDWITHURL] = Object.assign({}, oAbstractRecordTemplate,
			{
				Value: { Path: "" },
				Url: { String: "" }
			});
		oRecordTemplate[DATAFIELDWITHNAVPATH] = Object.assign({}, oAbstractRecordTemplate,
			{
				Value: { Path: "" },
				Target: { NavigationPropertyPath: "" }
			});
		oRecordTemplate[DATAFIELDFORANNOTATION] = Object.assign({}, oAbstractRecordTemplate,
			{
				Target: { AnnotationPath: "" }
			});
		oRecordTemplate[DATAFIELDFORACTION] = Object.assign({}, oAbstractRecordTemplate,
			{
				Inline: { Bool: "true" },
		...
		oRecordTemplate[INTENTBASEDNAV] = Object.assign({}, oAbstractRecordTemplate,
			{
				Action: { String: "" },
				SemanticObject: { String: "" },
				Value: { Path: "" }
			});
		oRecordTemplate[FORINTENTBASEDNAV] = Object.assign({}, oAbstractRecordTemplate,
			{
				Inline: { Bool: "true" },
				Determining: { Bool: "false" },
				Action: { String: "" },
