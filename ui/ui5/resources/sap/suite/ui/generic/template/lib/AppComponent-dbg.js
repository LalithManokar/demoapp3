...
//					oModel.enableCanonicalRequests(true);
		...
		function getInternalManifest() {
			if (!oInternalManifest) {
				...
				oInternalManifest = Object.assign({}, oAppComponent.getMetadata().getManifest());
		...
		if (sap.ui.getCore().getConfiguration().getDesignMode()){
			Object.assign(oMethods, oDesignTimeMethods);
		}
	...
	return UIComponent.extend("sap.suite.ui.generic.template.lib.AppComponent", {
		...
		constructor: function() {
			...
			Object.assign(this, getMethods(this, oAppId));
