sap.ui.define(["sap/suite/ui/microchart/InteractiveDonutChart",
...
],function(InteractiveDonutChart, InteractiveDonutChartSegment, JSONModel, FilterItemMicroChart, CriticalityUtil, FilterUtil, StableIdHelper) {
	"use strict";
	...
	FilterItemMicroDonut.prototype.init = function() {
		var sId = StableIdHelper.getStableId({type: "VisualFilter", subType: "InteractiveChart", sMicroChartId: this.getId()});
