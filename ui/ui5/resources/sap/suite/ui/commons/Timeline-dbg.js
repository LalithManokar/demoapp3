...
sap.ui.define([
	...
	Timeline.prototype._sortClick = function () {
		...
		this._objects.getSortIcon().setTooltip(this._sortOrder === SortOrder.ASCENDING ? resourceBundle.getText("TIMELINE_SORT_ASCENDING") : resourceBundle.getText("TIMELINE_SORT_DESCENDING"));
