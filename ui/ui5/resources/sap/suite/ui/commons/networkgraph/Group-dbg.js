...
sap.ui.define([
	...
	Group.prototype._renderHeader = function (mOptions) {
		...
		if (sTitle) {
			...
			sContentStyleVal = this.getStyleObject(sContentStyleVal);
			sContentStyleVal = this.applyStyles(sContentStyleVal);
			mOptions.renderManager.write("<div " + sContentStyleVal + " class=\"sapSuiteUiCommonsNetworkGroupHeaderTitle\">" + encodeXML(sTitle) + " </div>");
		}
		mOptions.renderManager.write("</div>");
