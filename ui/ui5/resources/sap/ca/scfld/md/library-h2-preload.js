 ...
 */
sap.ui.predefine('sap/ca/scfld/md/library',["sap/ui/core/Core","sap/ui/core/library","sap/m/library","sap/ca/ui/library"],function(){sap.ui.getCore().initLibrary({name:"sap.ca.scfld.md",dependencies:["sap.ui.core","sap.m","sap.ca.ui"],types:[],interfaces:[],controls:[],elements:[],noLibraryCSS:true,version:"1.71.2"});return sap.ca.scfld.md;});
sap.ui.require.preload({
	"sap/ca/scfld/md/manifest.json":'{"_version":"1.9.0","sap.app":{"id":"sap.ca.scfld.md","type":"library","embeds":[],"applicationVersion":{"version":"1.71.2"},"title":"SAP UI library: Scaffolding for Master Detail applications","description":"SAP UI library: Scaffolding for Master Detail applications","resources":"resources.json","offline":true},"sap.ui":{"technology":"UI5","supportedThemes":[]},"sap.ui5":{"dependencies":{"minUI5Version":"1.71","libs":{"sap.ui.core":{"minVersion":"1.71.29"},"sap.m":{"minVersion":"1.71.29"},"sap.ca.ui":{"minVersion":"1.71.2"}}},"library":{"i18n":false,"css":false,"content":{"controls":[],"elements":[],"types":[],"interfaces":[]}}}}'
