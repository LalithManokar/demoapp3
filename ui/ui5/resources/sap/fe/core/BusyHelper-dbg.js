...
sap.ui.define(["sap/ui/base/Object", "sap/fe/core/internal/testableHelper"], function(BaseObject, testableHelper) {
	"use strict";
	...
	function getMethods(oTemplateContract) {
		...
		return {
			...
			isBusy: isBusy,
			getUnbusy: function() {
				// returns a Promise that is resolved as soon as the App is not in a busy session
	...
	return BaseObject.extend("sap.fe.core.BusyHelper", {
		constructor: function(oTemplateContract) {
			Object.assign(this, testableHelper.testableStatic(getMethods, "BusyHelper")(oTemplateContract));
		}
	});
});
