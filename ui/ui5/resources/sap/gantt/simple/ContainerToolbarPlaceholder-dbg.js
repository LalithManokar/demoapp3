	...
	var ContainerToolbarPlaceholder = Control.extend("sap.gantt.simple.ContainerToolbarPlaceholder", /** @lends sap.gantt.simple.ContainerToolbarPlaceholder.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 * @deprecated since 1.71.59. This is a private property and it is being removed from UI5 version 1.117. We recommend not using this property. In case you want to use it, contact us using CA-UI5-CTR-GNT.
				 * @private
				 */
			...
			aggregations: {
				/**
				 * Represented control.
				 * @deprecated since 1.71.59. This is a private aggregation and it is being removed from UI5 version 1.117. We recommend not using this aggregation. In case you want to use it, contact us using CA-UI5-CTR-GNT.
				 * @private
				 */
