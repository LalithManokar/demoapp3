 ...
 */
sap.ui.define([
	"./TitlePropagator", "./BaseShape", "./RenderUtils", "./GanttUtils", "../misc/Format", "sap/gantt/misc/Utility"
], function (TitlePropagator, BaseShape, RenderUtils, GanttUtils, Format, Utility) {
	"use strict";
