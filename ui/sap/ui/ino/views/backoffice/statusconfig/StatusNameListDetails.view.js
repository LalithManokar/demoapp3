...
sap.ui.jsview("sap.ui.ino.views.backoffice.statusconfig.StatusNameListDetails", {

	getControllerName: function() {
		return "sap.ui.ino.views.backoffice.statusconfig.StatusNameListDetails";
	},
	...
	createContent: function(oController) {
		...
		this.oDetailData.addRow(this._labeledTextRow("{i18n>BO_STATUS_NAME_FLD_DEFAULT_TEXT}",
			new sap.ui.commons.TextView({
				text: "{DEFAULT_TEXT}"
			})));
		this.oTypeRow = this._labeledTextRow("{i18n>BO_STATUS_NAME_FLD_TYPE}",
			new sap.ui.commons.TextView({
				text: "{STATUS_TYPE}"
			}));
		this.oDetailData.addRow(this.oTypeRow);

		this.oDescriptionRow = this._labeledTextRow("{i18n>BO_STATUS_NAME_FLD_DEFAULT_LONG_TEXT}",
			new sap.ui.commons.TextView({
		...
		this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_STATUS_NAME_ROW_CREATED_AT}",
		...
		this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_STATUS_NAME_ROW_CREATED_BY}",
		...
		this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_STATUS_NAME_ROW_CHANGED_AT}",
			new sap.ui.ino.controls.TextView({
				text: {
					path: "CHANGED_AT",
					type: new sap.ui.model.type.Date()
		...
		this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_STATUS_NAME_ROW_CHANGED_BY}",
			new sap.ui.commons.Link({
				text: "{CHANGED_BY}",
		...
		var oPanel = new sap.ui.commons.Panel({
			...
			text: "{i18n>BO_STATUS_NAME_DETAILS_HEADER}"
		});
