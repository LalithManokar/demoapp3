...
sap.ui.jsview("sap.ui.ino.views.backoffice.statusconfig.StatusNameList", jQuery.extend({},
	sap.ui.ino.views.common.MasterDetailView, {
		getControllerName: function() {
			return "sap.ui.ino.views.backoffice.statusconfig.StatusNameList";
		},
		...
		createColumns: function() {
			...
			return [sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CODE"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_STATUS_NAME_LIST_ROW_CODE}"
					}),
					...
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_STATUS_NAME_LIST_ROW_PACKAGE_ID}"
					}),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_TEXT"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_STATUS_NAME_LIST_ROW_DEFAULT_TEXT}"
					}),
					template: new sap.ui.commons.TextView({
						text: "{DEFAULT_TEXT}"
					}),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("STATUS_TYPE"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_STATUS_NAME_LIST_ROW_TYPE}"
					}),
					template: new sap.ui.commons.TextView({
						text: "{STATUS_TYPE}"
					}),
					sortProperty: "STATUS_TYPE",
					filterProperty: "STATUS_TYPE"
				})),
                new sap.ui.table.Column(this.createId("CHANGED_AT"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_STATUS_NAME_LIST_ROW_CHANGED_AT}"
					}),
					template: new sap.ui.commons.TextView({
						text: {
							path: "CHANGED_AT",
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CHANGED_BY"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_STATUS_NAME_LIST_ROW_CHANGED_BY}"
					}),
					template: new sap.ui.commons.Link({
						text: "{CHANGED_BY}",
		...
		createActionButtons: function(oController) {
			...
			this._oCreateButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_STATUS_NAME_LIST_BUT_CREATE}",
			...
			this._oCopyButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_STATUS_NAME_LIST_BUT_COPY}",
			...
			this._oEditButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_STATUS_NAME_LIST_BUT_EDIT}",
			...
			this._oDeleteButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_STATUS_NAME_LIST_BUT_DELETE}",
		...
		createCopyAsDialog: function() {
			...
			var oCopyAsCodeLabel = new sap.ui.commons.Label({
				text: "{i18n>BO_STATUS_NAME_LIST_COPY_PLAIN_CODE}"
			});
			...
			this.oCopyAsDialog = new sap.ui.commons.Dialog({
				title: "{i18n>BO_STATUS_NAME_MODEL_TIT_DIALOG_COPY}",
		...
		createDetailsView: function() {
			return sap.ui.jsview("sap.ui.ino.views.backoffice.statusconfig.StatusNameListDetails");
		}
	}));