...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.ValueOptionList", jQuery.extend({},
        sap.ui.ino.views.common.MasterDetailView, {
            getControllerName : function() {
                return "sap.ui.ino.views.backoffice.config.ValueOptionList";
            },
            ...
            createColumns : function() {
                ...
                return [sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CODE"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_CODE}"
                    }),
                    template : new sap.ui.commons.Link({
                        ...
                        press : function(oEvent) {
                            ...
                            oController.onNavigateToValueOptionList(iId);
                        },
                    }),
                    sortProperty : "CODE",
                    filterProperty : "CODE"
                    ...
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_PACKAGE_ID}"
                    }),
                ...
                })), sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DATA_TYPE"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_DATA_TYPE}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{DATATYPE_CODE}"
                    }),
                    sortProperty : "DATATYPE_CODE",
                    filterProperty : "DATATYPE_CODE"
                })),
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_TEXT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_DEFAULT_TEXT}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{DEFAULT_TEXT}"
                    }),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_LONG_TEXT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_DEFAULT_LONG_TEXT}"
                    }),
                    template : new sap.ui.commons.TextView({
                ...
                new sap.ui.table.Column(this.createId("CHANGED_AT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_CHANGED_AT}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : {
                            path : "CHANGED_AT",
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CHANGED_BY"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_VALUE_OPTION_LIST_ROW_CHANGED_BY}"
                    }),
                    template : new sap.ui.commons.Link({
                        text : "{CHANGED_BY}",
            ...
            createActionButtons : function(oController) {
                this._oCreateButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_VALUE_OPTION_LIST_BUT_CREATE}",
                ...
                this._oEditButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_VALUE_OPTION_LIST_BUT_EDIT}",
                ...
                this._oCopyButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_VALUE_OPTION_LIST_BUT_COPY}",
                ...
                this._oDeleteButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_VALUE_OPTION_LIST_BUT_DELETE}",
                    press : [oController.onDeletePressed, oController],
                    lite : false,
                    enabled : "{property>/actions/del/enabled}",
                    tooltip : {
                        parts : [{
                            path : "property>/actions/del/messages",
                        }, {
                            path : "PLAIN_CODE"
                        }],
                        formatter : function(aMessages, sPlainCode) {
            ...
            createDetailsView : function() {
                return sap.ui.jsview("sap.ui.ino.views.backoffice.config.ValueOptionListDetails");
            },
            ...
            createCopyAsDialog : function() {
                ...
                var oCopyAsCodeLabel = new sap.ui.commons.Label({
                    text: "{i18n>BO_VALUE_OPTION_LIST_FLD_CODE}"
                });
                ...
                this.oCopyAsDialog = new sap.ui.commons.Dialog({
                    title : "{i18n>BO_VALUE_OPTION_LIST_TIT_DIALOG_COPY}",
