...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.ResponsibilityLists", jQuery.extend({},
	sap.ui.ino.views.common.MasterDetailView, {
		getControllerName: function() {
			return "sap.ui.ino.views.backoffice.config.ResponsibilityLists";
		},
		...
		createColumns: function() {
			...
			return [sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CODE"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_CODE}"
					}),
					...
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_PACKAGE_ID}"
					}),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_TEXT"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_DEFAULT_TEXT}"
					}),
					template: new sap.ui.commons.TextView({
						text: "{DEFAULT_TEXT}"
					}),
					...
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_IS_MANAGER_PUBLIC}"
					}),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_LONG_TEXT"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_DEFAULT_LONG_TEXT}"
					}),
					template: new sap.ui.commons.TextView({
                ...
                new sap.ui.table.Column(this.createId("CREATED_AT"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_CREATED_AT}"
					}),
					template: new sap.ui.commons.TextView({
						text: {
							path: "CREATED_AT",
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CREATED_BY"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_CREATED_BY}"
					}),
					template: new sap.ui.commons.Link({
						text: "{CREATED_BY}",
                ...
                new sap.ui.table.Column(this.createId("CHANGED_AT"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_CHANGED_AT}"
					}),
					template: new sap.ui.commons.TextView({
						text: {
							path: "CHANGED_AT",
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CHANGED_BY"), {
					label: new sap.ui.commons.Label({
						text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_ROW_CHANGED_BY}"
					}),
					template: new sap.ui.commons.Link({
						text: "{CHANGED_BY}",
		...
		createActionButtons: function(oController) {
			this._oCreateButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_BUT_CREATE}",
				press: [oController.onCreatePressed, oController],
				lite: false,
				enabled: {
					parts: [{
						path: "property>/actions/create/enabled",
						type: null
    				}, {
						path: "applicationSelectedObject>/IS_MANAGER_PUBLIC",
						type: null
    				}],
			...
			this._oEditButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_BUT_EDIT}",
				press: [oController.onEditPressed, oController],
				lite: false,
				enabled: {
					parts: [{
						path: "property>/actions/update/enabled",
						type: null
    				}, {
						path: "applicationSelectedObject>/IS_MANAGER_PUBLIC",
						type: null
			...
			this._oCopyButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_BUT_COPY}",
				press: [oController.onCopyAsPressed, oController],
				lite: false,
				enabled: {
					parts: [{
						path: "property>/actions/copy/enabled",
						type: null
    				}, {
						path: "applicationSelectedObject>/IS_MANAGER_PUBLIC",
						type: null
			...
			this._oDeleteButton = new sap.ui.commons.Button({
				...
				text: "{i18n>BO_RESPONSIBILITY_LIST_LIST_BUT_DELETE}",
				press: [oController.onDeletePressed, oController],
				lite: false,
				enabled: {
					parts: [{
						path: "property>/actions/del/enabled",
						type: null
    				}, {
						path: "applicationSelectedObject>/IS_MANAGER_PUBLIC",
						type: null
		...
		createCopyAsDialog: function() {
			...
			var oCopyAsCodeLabel = new sap.ui.commons.Label({
				text: "{i18n>BO_RESPONSIBILITY_LIST_FLD_PLAIN_CODE}"
			});
			...
			this.oCopyAsDialog = new sap.ui.commons.Dialog({
				title: "{i18n>BO_MODEL_TIT_DIALOG_COPY}",
