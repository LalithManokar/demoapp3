...
sap.ui.core.mvc.Controller.extend("sap.ui.ino.views.backoffice.homepagewidget.CommunityHomePageWidget", {
    ...
    initPageData: function() {
        ...
        var oDeffered = sap.ui.ino.models.object.Homepagewidget.getCommunityHomepageWidget();
    ...
    onRefreshPreview: function() {
        ...
        try {
            var $IFrame = document.getElementsByName("community_homepage_preview");
            ...
            var fnCreateContent = function() {
                ...
                oIFrame.contentWindow.createContent([sContent], "community_homepage_preview");
            }.bind(this);
            ...
            var oRewardMessages = new sap.ui.ino.application.Message({
				text: e.toString(),
				key: "community_homepage_preview",
    ...
    onSavePressed: function() {
        ...
        oDeffered.done(function() {
            ...
            var oMessageParameters = {
				key: "MSG_COMMUNITY_HOMEPAGE_SAVED",
				level: sap.ui.core.MessageType.Success,
				parameters: [],
				group: "homepage_preview",
				text: oMsg.getResourceBundle().getText("MSG_COMMUNITY_HOMEPAGE_SAVED")
			};
