...
sap.ui.jsview("sap.ui.ino.views.backoffice.tag.TagGroupManagementListDetails", {

    getControllerName : function() {
        return "sap.ui.ino.views.backoffice.tag.TagGroupManagementListDetails";
    },
    ...
    createContent : function(oController) {
        ...
        this.oDetailData.addRow(this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_NAME}",
                new sap.ui.commons.TextView({
                    text : "{NAME}"
                })));

        this.oTopNumber = this._labeledTextRow("{i18n>BO_TAG_GROUP_NUMBER_FLD_MAXIMUM_NUMBER}", new sap.ui.commons.TextView({
            text : "{TOP_NUMBER}"
        }));
        this.oDetailData.addRow(this.oTopNumber);

        this.oMembersRow = this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_TAGS_COUNT}",
                new sap.ui.commons.TextView({
                    text : "{TAGS_COUNT}"
                }));
        this.oDetailData.addRow(this.oMembersRow);

        this.oDescriptionRow = this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_DESCRIPTION}",
                new sap.ui.commons.TextView({
                    text : "{DESCRIPTION}"
                }));
        ...
        this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_CREATED_AT}",
        ...
        this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_CREATED_BY}",
        ...
        this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_CHANGED_AT}",
                new sap.ui.ino.controls.TextView({
                    text : {
                        path : "CHANGED_AT",
                        type : new sap.ui.model.type.Date()
        ...
        this.oDetailRightData.addRow(this._labeledTextRow("{i18n>BO_TAG_GROUP_LIST_FLD_CHANGED_BY}",
                new sap.ui.commons.Link({
                    text : "{CHANGED_BY}",
        ...
        var oPanel = new sap.ui.commons.Panel({
            ...
            text : "{i18n>BO_TAG_GROUP_LIST_DETAILS_HEADER}"
        });
