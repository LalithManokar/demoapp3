...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.CampaignPhaseListDetails", {

    getControllerName : function() {
        return "sap.ui.ino.views.backoffice.config.CampaignPhaseListDetails";
    },
    ...
    createContent : function(oController) {
        var oPanel = new sap.ui.commons.Panel({
            ...
            text : "{i18n>BO_PHASE_LIST_DETAILS_HEADER}"
        });
        ...
        var oRow = this.createPhaseDetailRow();
        oLayout.addRow(oRow);
    ...
    createPhaseDetailRow : function() {
        ...
        var oContent = this.createPhaseDetailLeft();
        ...
        oContent = this.createPhaseDetailMiddle();
        oCell.addContent(oContent);
        oRow.addCell(oCell);
        ...
        oContent = this.createPhaseDetailRight();
        oCell.addContent(oContent);
        oRow.addCell(oCell);
    ...
    createPhaseDetailLeft : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : '100%',
    ...
    createPhaseDetailMiddle : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : '100%',
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_PHASE_FLD_CREATED_AT}",
            design : sap.ui.commons.LabelDesign.Bold
        });
    ...
    createPhaseDetailRight : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : '100%',
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_PHASE_FLD_CREATED_BY}",
            design : sap.ui.commons.LabelDesign.Bold
        });
