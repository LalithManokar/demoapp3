...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.CampaignPhaseUsageFacet", jQuery.extend({},
        sap.ui.ino.views.common.UsageFacetView, {

            getControllerName : function() {
                return "sap.ui.ino.views.backoffice.config.CampaignPhaseUsageFacet";
            },
            ...
            createColumns : function(){
                ...
                var oCampaignColumn = new sap.ui.table.AnalyticalColumn({
                    label : new sap.ui.commons.Label({
                        text : "{/#PhaseUsageType/CAMPAIGN_NAME/@sap:label}"
                    }),
                ...
                var oCampaignIDColumn = new sap.ui.table.AnalyticalColumn({
                    label : new sap.ui.commons.Label({
                        text : "{/#PhaseUsageType/CAMPAIGN_ID/@sap:label}"
                    }),
                    template : new sap.ui.commons.Link({
                        text : {
                            path : "CAMPAIGN_ID",
                ...
                var oCountColumn = new sap.ui.table.AnalyticalColumn({
                    label : new sap.ui.commons.Label({
                        text : "{/#PhaseUsageType/CAMPAIGN_COUNT/@sap:label}"
                    }),
            ...
            getTableBindingInformation : function(){
                ...
                var aFilters = [];
                var oTagFilter = new sap.ui.model.Filter("PHASE_CODE", sap.ui.model.FilterOperator.EQ, sCode);
