...
sap.ui.jsview("sap.ui.ino.views.backoffice.homepagewidget.CommunityHomePageWidget", jQuery.extend({}, sap.ui.ino.views.common.MessageSupportView, {
    init: function() {
    ...
    getControllerName : function() {
        return "sap.ui.ino.views.backoffice.homepagewidget.CommunityHomePageWidget";
    },
    ...
    addPreview: function(oLayout) {
		...
		var sUrl = sap.ui.ino.application.Configuration.getFullApplicationPath("sap.ino.config.URL_PATH_UI_COMMUNITY_HOMEPAGE_PREVIEW");
        ...
        if (sUrl) {
            sContent = "<div style='width: 100%'><iframe name='community_homepage_preview' src='" + sUrl + 
    ...
    getRichTextEditor: function() {
		...
		oRichTextField.attachReady(function(oEvent) {
		    oEvent.getSource().setHeight("400px");
		});
