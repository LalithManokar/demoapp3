...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.TextModuleListDetails", {

    getControllerName : function() {
        return "sap.ui.ino.views.backoffice.config.TextModuleListDetails";
    },
    ...
    setRowContext : function(oBindingContext) {
        ...
        var sKey = "StagingTextModule(" + iID + ")";
    ...
    createContent : function() {
        var oPanel = new sap.ui.commons.Panel({
            ...
            text : "{i18n>BO_TEXT_MODULE_LIST_DETAILS_HEADER}"
        });
        ...
        var oRow = this.createTextModuleDetailRow();
        oLayout.addRow(oRow);
    ...
    createTextModuleDetailRow : function() {
        ...
        var oContent = this.createTextModuleDetailLeft();
        ...
        oContent = this.createTextModuleDetailMiddle();
        oCell.addContent(oContent);
        oRow.addCell(oCell);
        ...
        oContent = this.createTextModuleDetailRight();
        oCell.addContent(oContent);
        oRow.addCell(oCell);
    ...
    createTextModuleDetailLeft : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : "100%",
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_TEXT_MODULE_FLD_TEXT}",
    ...
    createTextModuleDetailMiddle : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : "100%",
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_TEXT_MODULE_FLD_CREATED_AT}",
            design : sap.ui.commons.LabelDesign.Bold
        });
    ...
    createTextModuleDetailRight : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : "100%",
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_TEXT_MODULE_FLD_CREATED_BY}",
            design : sap.ui.commons.LabelDesign.Bold
        });
