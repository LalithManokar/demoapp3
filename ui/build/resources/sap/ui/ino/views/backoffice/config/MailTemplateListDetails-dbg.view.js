...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.MailTemplateListDetails", {

    getControllerName : function() {
        return "sap.ui.ino.views.backoffice.config.MailTemplateListDetails";
    },
    ...
    setRowContext : function(oBindingContext) {
        ...
        var sKey = "StagingMailTemplate(" + iID + ")";
    ...
    createContent : function(oController) {
        var oPanel = new sap.ui.commons.Panel({
            ...
            text : "{i18n>BO_MAIL_TEMPLATE_LIST_DETAILS_HEADER}"
        });
        ...
        var oRow = this.createMailTemplateDetailRow();
        oLayout.addRow(oRow);
    ...
    createMailTemplateDetailRow : function() {
        ...
        var oContent = this.createMailTemplateDetailLeft();
        ...
        oContent = this.createMailTemplateDetailMiddle();
        oCell.addContent(oContent);
        oRow.addCell(oCell);
        ...
        oContent = this.createMailTemplateDetailRight();
        oCell.addContent(oContent);
        oRow.addCell(oCell);
    ...
    createMailTemplateDetailLeft : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : '100%',
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_MAIL_TEMPLATE_FLD_TEXT}",
    ...
    createMailTemplateDetailMiddle : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : '100%',
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_MAIL_TEMPLATE_FLD_CREATED_AT}",
            design : sap.ui.commons.LabelDesign.Bold
        });
    ...
    createMailTemplateDetailRight : function() {
        var oLayout = new sap.ui.commons.layout.MatrixLayout({
            layoutFixed : true,
            columns : 2,
            width : '100%',
        ...
        var oLabel = new sap.ui.commons.Label({
            text : "{i18n>BO_MAIL_TEMPLATE_FLD_CREATED_BY}",
            design : sap.ui.commons.LabelDesign.Bold
        });
