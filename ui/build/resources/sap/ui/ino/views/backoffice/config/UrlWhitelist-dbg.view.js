...
sap.ui.jsview("sap.ui.ino.views.backoffice.config.UrlWhitelist", jQuery.extend({},
        sap.ui.ino.views.common.MasterDetailView, {
            getControllerName : function() {
                return "sap.ui.ino.views.backoffice.config.UrlWhitelist";
            },
            ...
            createColumns : function() {
                ...
                return [sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CODE"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_CODE}"
                    }),
                    template : new sap.ui.commons.Link({
                        ...
                        press : function(oEvent) {
                            ...
                            oController.onNavigateToModify(iId);
                        }
                    }),
                    sortProperty : "CODE",
                    filterProperty : "CODE"
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("PACKAGE_ID"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_PACKAGE_ID}"
                    }),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_TEXT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_DEFAULT_TEXT}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{DEFAULT_TEXT}"
                    }),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("DEFAULT_LONG_TEXT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_DEFAULT_LONG_TEXT}"
                    }),
                    template : new sap.ui.commons.TextView({
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("PROTOCOL"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_PROTOCOL}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{PROTOCOL}"
                    }),
                    sortProperty : "PROTOCOL",
                    filterProperty : "PROTOCOL"
                })),
                
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("HOST"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_HOST}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{HOST}"
                    }),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("PORT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_PORT}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{PORT}"
                    }),
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("PATH"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_PATH}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : "{PATH}"
                    }),
                ...
                new sap.ui.table.Column(this.createId("CREATED_AT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_CREATED_AT}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : {
                            path : "CREATED_AT",
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CREATED_BY"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_CREATED_BY}"
                    }),
                    template : new sap.ui.commons.Link({
                        text : "{CREATED_BY}",
                ...
                new sap.ui.table.Column(this.createId("CHANGED_AT"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_CHANGED_AT}"
                    }),
                    template : new sap.ui.commons.TextView({
                        text : {
                            path : "CHANGED_AT",
                ...
                sap.ui.ino.models.util.Table.caseInsensitiveColumn(new sap.ui.table.Column(this.createId("CHANGED_BY"), {
                    label : new sap.ui.commons.Label({
                        text : "{i18n>BO_URL_WHITELIST_ROW_CHANGED_BY}"
                    }),
                    template : new sap.ui.commons.Link({
                        text : "{CHANGED_BY}",
            ...
            createActionButtons : function(oController) {
                this._oCreateButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_URL_WHITELIST_BUT_CREATE}",
                ...
                this._oEditButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_URL_WHITELIST_BUT_EDIT}",
                ...
                this._oCopyButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_URL_WHITELIST_BUT_COPY}",
                ...
                this._oDeleteButton = new sap.ui.commons.Button({
                    ...
                    text : "{i18n>BO_URL_WHITELIST_BUT_DELETE}",
                    press : [oController.onDeletePressed, oController],
                    lite : false,
                    enabled : "{property>/actions/del/enabled}"
                });
                
                this._oImportButton = new sap.ui.commons.Button({
                    id : this.createId("BUT_IMPORT"),
                    text : "{i18n>BO_URL_WHITELIST_BUT_IMPORT}",
                    press : [oController.onImportPressed, oController],
                    lite : false,
                    enabled : "{property>/actions/create/customProperties/migrateEnabled}"
                });
                
                //also create the CopyAsDialog 
                this.createCopyAsDialog();

                return [this._oCreateButton, this._oEditButton, this._oCopyButton, this._oDeleteButton, this._oImportButton];
            },

            createDetailsView : function() {
                return sap.ui.jsview("sap.ui.ino.views.backoffice.config.UrlWhitelistDetails");
            },
            ...
            createCopyAsDialog : function() {
                ...
                var oCopyAsCodeLabel = new sap.ui.commons.Label({
                    text: "{i18n>BO_URL_WHITELIST_FLD_PLAIN_CODE}"
                });
                ...
                this.oCopyAsDialog = new sap.ui.commons.Dialog({
                    title : "{i18n>BO_URL_WHITELIST_TIT_DIALOG_COPY}",
