...
sap.ui.define([
    ...
    'use strict';
    return Control.extend("sap.ui.ino.controls.Milestone", {
        metadata: {
            properties: {
                "Id": {
                    type: "int"
        ...
        init: function() {
             this._oRB = sap.ui.getCore().getLibraryResourceBundle("sap.ui.ino.controls");
        },
        ...
        getTemplateText: function(task){
            ...
            $.extend(task, {
                TEMPLATE_TEXT:{
                    TASK: i18n.getText('BO_MILESTONE_TASK_LABEL'),
                    START: i18n.getText('BO_MILESTONE_START_LABEL'),
                    END: i18n.getText('BO_MILESTONE_END_LABEL'),
                    INFINITY: i18n.getText('BO_MILESTONE_INFINITY')
                }
            });
        },
            ...
            if(nowTime < maxTime && nowTime > minTime){
                ...
                var currentText = rectangles.append('text')
                    .text(function(){
                        ...
                        return i18n.getText('BO_MILESTONE_TODAY') + ': ' + sToday;
                    })
                    .attr('class', 'now-date')
                    .attr('x', function(){
                        var today = nowTime < maxTime ? nowTime : maxTime; 
