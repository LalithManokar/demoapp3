...
var bkLib = {
    ...
    addEvent : function(obj, type, fn) {
        (obj.addEventListener) ? obj.addEventListener(type, fn, false) : obj.attachEvent("on" + type, fn); // jshint ignore:line
    },
...
var nicEditor = bkClass.extend({
    ...
    selectCheck : function(e, t) {
        var found = false;
        do {
            // mod start: add text editor class
            if(t.className && (t.className.indexOf('nicEdit') != -1 || t.className.indexOf('sapInoWallTextEditor') != -1)) {
            // mod end
...
//		  sap edited to deny the occurance of  pending changes
//        if (this.getContent() == "") {
//            this.setContent('<br />');
//        }
