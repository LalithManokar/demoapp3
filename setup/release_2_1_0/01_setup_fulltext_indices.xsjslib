...
const whoAmI = "sap.ino.setup.release_2.1.0.01_setup_fulltext_indices.xsjslib";
...
const aIndices = [
    {
        schema: "SAP_INO", table: "sap.ino.db.blog::t_blog", column: "TITLE", index: "sap.ino.db.blog::i_blog_title",
        languages: aSupportedLangs, textanalysis: true,
        foreignKey: {
            column: "ID"
        }, overwrite: true
    },{
        schema: "SAP_INO", table: "sap.ino.db.blog::t_blog", column: "DESCRIPTION", index: "sap.ino.db.blog::i_blog_description",
        languages: aSupportedLangs, textanalysis: true, mimetypeColumn:"DESCRIPTION_MIME_TYPE",
        foreignKey: {
            column: "ID"
        }, overwrite: true
    }
