...
const whoAmI = 'sap.ino.setup.release_independent.01_activate_p_campaign_search.xsjslib';
...
function run(oConnection) {
    // the procedure sap.ino.db.blog::p_blog_search contains SQL code, 
    ...
    // in p_blog_search with a special comment --ACTIVATE_AFTER_IMPORT and that this comment
